            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <FaStar className="text-yellow-500" />
                  <FaStar className="text-yellow-500" />
                  <span className="text-xs lg:text-sm">(5 Star)</span>
                </div>
              </div>
                ...
                <button
                  ...
                  className={`flex min-w-[132px] items-center justify-center gap-1 rounded-md ${
                    book.isFavorite
                      ...
                      : " bg-[#1e272e]/[14%] py-1.5 text-[#1e272e] transition-all hover:bg-[#1e272e]/[24%] lg:py-1.5"
                  } `}
                >
                  <FaHeart />

                  {book.isFavorite ? "Favorite" : "UnFavorite"}
                </button>
              </div>
            </div>
          </div>
